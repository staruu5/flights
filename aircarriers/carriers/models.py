...
class Flights(models.Model):
    ...
    departure_airport = models.ForeignKey(Airports, on_delete=models.CASCADE, related_name='departure_airport')
    arrival_airport = models.ForeignKey(Airports, on_delete=models.CASCADE, related_name='arrival_airport')
